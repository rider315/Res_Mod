...
export const metadata = {
  title: 'Shipping and Delivery Policy | Chills',
}
  ...
  return (
    <PolicyPage title="Shipping and Delivery Policy" updated="16 September 2026">
      <PolicySection title="Nothing is shipped">
        <p>Chills is an online service. It sells no physical goods, so nothing is shipped and there are no delivery charges.</p>
      </PolicySection>

      <PolicySection title="Tailorings and Pro">
        <p>
          Credit packs and Pro are added to your Chills account as soon as Razorpay confirms the payment, usually within a
